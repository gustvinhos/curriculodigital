...
class Resumo:
    ...
    def bar_chart_areacourses(self):
        ...
        st.plotly_chart(px.bar(area_courses, orientation='h', title='Áreas com mais cursos', labels={'value':'','Área do Curso':''}), use_container_width=True,)
